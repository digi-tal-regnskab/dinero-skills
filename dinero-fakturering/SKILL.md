...
først ved **bogføring** — og dér KAN det angives eksplicit (bogføringen afvises,
hvis nummeret er optaget); uden angivelse tildeles det næste i serien. Et forbrugt
nummer kan aldrig genbruges — selv hvis dokumentet slettes i Dineros UI bagefter.
Ét bogført testdokument = permanent hul i serien. Derfor: kladde → gennemsyn →
bogfør kun på accept. Skal flere dokumenter have bestemte numre, angiv dem
eksplicit ved bogføringen i stedet for at stole på rækkefølgen; ellers: sekventielt,
